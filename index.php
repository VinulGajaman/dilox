                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="resourses/carosel/new/bk1.png" class="img-fluid login_img" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="resourses/carosel/new/bk3.png" class="img-fluid login_img" alt="...">
                            </div>
                        </div>
                ...
                <div class="col-lg-7 text-center mt-4">
                    <div class="row">
                        <div class="col-12 d-lg-block">
                            <img src="new/logo2.png" height="80px">
                            <h1 class="mt-1 animate__animated animate__fadeIn animate__infinite infinite title1" style="font-size: 5rem;">Dilox Clothing</h1>
                        </div>
